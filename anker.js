...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:DARK BOT\n'
            + 'ORG:Owner Gans;\n'
            + 'TEL;type=CELL;type=VOICE;waid=966572004810:+966 200-4810\n'
            + 'END:VCARD'
...
premium = ["966572004810@s.whatsapp.net"]
...
async function starts() {
	...
	dms.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["966572004810@s.whatsapp.net"] // owner number ubah aja
